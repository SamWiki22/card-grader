...
const COMPANIES = {
  ...
  TAG: { name: "TAG", color: "#43A047", tiers: [
    ...
    { min: 9.20, short: "GEM MINT 10",  color: "#E8E8E8", badge: "💎", likely: "TAG 10 Gem Mint",  verdict: "Exceptional card. TAG 10 Gem Mint — the standard top grade most collectors receive." },
    { min: 8.70, short: "MINT 9.5",     color: "#64B5F6", badge: "⭐", likely: "TAG 9.5 Mint",     verdict: "Very strong card. Likely TAG 9.5 Mint." },
    { min: 8.20, short: "MINT 9",       color: "#81C784", badge: "✅", likely: "TAG 9 Mint",       verdict: "Solid card with minor wear. Likely TAG 9 Mint." },
    { min: 7.20, short: "NEAR MINT",    color: "#FFB74D", badge: "📋", likely: "TAG 7.5–8",        verdict: "Noticeable wear. Likely TAG 7.5–8." },
    { min: 0,    short: "BELOW NM",     color: "#EF5350", badge: "⚠️", likely: "TAG 7 or lower",   verdict: "Significant defects." },
  ]},
  CGC: { name: "CGC", color: "#AB47BC", tiers: [
    { min: 9.20, short: "PRISTINE 10",  color: "#FFD700", badge: "🏆", likely: "CGC 10 Pristine",  verdict: "Near-flawless. CGC Pristine 10 is difficult to achieve — strong candidate at this score." },
    { min: 8.60, short: "GEM MINT 9.5", color: "#E8E8E8", badge: "💎", likely: "CGC 9.5 Gem Mint", verdict: "Exceptional card. Likely CGC 9.5 Gem Mint." },
    { min: 8.10, short: "MINT 9",       color: "#64B5F6", badge: "⭐", likely: "CGC 9 Mint",       verdict: "Very strong card. Likely CGC 9 Mint." },
    { min: 7.40, short: "NM/MT+ 8.5",   color: "#81C784", badge: "✅", likely: "CGC 8.5 NM/MT+",  verdict: "Solid card. Likely CGC 8.5." },
    { min: 6.60, short: "NM/MT 8",      color: "#FFB74D", badge: "📋", likely: "CGC 7.5–8",        verdict: "Noticeable wear. Likely CGC 7.5–8." },
