...
const COMPANIES = {
  BGS: { name: "Beckett BGS", color: "#FFD700", tiers: [
    { min: 9.70, short: "BLACK LABEL", color: "#FFD700", badge: "🏆", likely: "BGS 10 Black Label", verdict: "Near-perfect across all subgrades. BGS Black Label 10 candidate — rarest result in the hobby." },
    { min: 9.30, short: "PRISTINE",    color: "#E8E8E8", badge: "💎", likely: "BGS 10 Pristine",    verdict: "Exceptional quality. Strong BGS Pristine 10 candidate." },
    { min: 8.80, short: "GEM MINT",    color: "#64B5F6", badge: "⭐", likely: "BGS 9.5 Gem Mint",   verdict: "Very strong card. Likely BGS 9.5 Gem Mint — BGS grades tough." },
    { min: 8.20, short: "NM-MT",       color: "#81C784", badge: "✅", likely: "BGS 8–8.5",          verdict: "Solid card with minor flaws. Likely BGS 8 or 8.5." },
    { min: 7.20, short: "NEAR MINT",   color: "#FFB74D", badge: "📋", likely: "BGS 7–7.5",          verdict: "Noticeable wear. Likely BGS 7–7.5." },
  ...
  PSA: { name: "PSA", color: "#E53935", tiers: [
    { min: 9.00, short: "GEM MT 10", color: "#FFD700", badge: "🏆", likely: "PSA 10 Gem Mint", verdict: "Excellent condition. Strong PSA 10 Gem Mint candidate — AI grading is conservative, real-world result likely a 10." },
    { min: 8.50, short: "MINT 9",    color: "#E8E8E8", badge: "💎", likely: "PSA 9 Mint",      verdict: "Very strong card with minimal flaws. Likely PSA 9 Mint." },
    { min: 7.50, short: "NM-MT 8",   color: "#64B5F6", badge: "⭐", likely: "PSA 8 NM-MT",     verdict: "Nice card with minor wear. Likely PSA 8 NM-MT." },
    { min: 6.50, short: "NM 7",      color: "#81C784", badge: "✅", likely: "PSA 7 NM",        verdict: "Solid card with noticeable wear. Likely PSA 7." },
    { min: 5.50, short: "EX-MT 6",   color: "#FFB74D", badge: "📋", likely: "PSA 5–6",         verdict: "Visible wear and defects. Likely PSA 5 or 6." },
  ...
  TAG: { name: "TAG", color: "#43A047", tiers: [
    { min: 9.60, short: "PERFECT 10",   color: "#FFD700", badge: "🏆", likely: "TAG 10 Perfect",   verdict: "Near-flawless. TAG grades as tough as BGS — this is a strong TAG 10 candidate." },
    { min: 9.20, short: "GEM MINT 9.5", color: "#E8E8E8", badge: "💎", likely: "TAG 9.5 Gem Mint", verdict: "Exceptional card. Likely TAG 9.5 Gem Mint — TAG holds a high standard." },
  ...
  CGC: { name: "CGC", color: "#AB47BC", tiers: [
    { min: 8.80, short: "PRISTINE 10",  color: "#FFD700", badge: "🏆", likely: "CGC 10 Pristine",  verdict: "Excellent condition. Strong CGC 10 Pristine candidate — CGC grades similarly to PSA." },
    { min: 8.40, short: "GEM MINT 9.5", color: "#E8E8E8", badge: "💎", likely: "CGC 9.5 Gem Mint", verdict: "Very strong card. Likely CGC 9.5 Gem Mint." },
    { min: 7.90, short: "MINT 9",       color: "#64B5F6", badge: "⭐", likely: "CGC 9 Mint",       verdict: "Good condition. Likely CGC 9 Mint." },
    { min: 7.30, short: "NM/MT+ 8.5",   color: "#81C784", badge: "✅", likely: "CGC 8.5 NM/MT+",  verdict: "Solid card. Likely CGC 8.5." },
    { min: 6.50, short: "NM/MT 8",      color: "#FFB74D", badge: "📋", likely: "CGC 7.5–8",        verdict: "Noticeable wear. Likely CGC 7.5–8." },
